  ...
  <div class="header">
      ...
      <div class="dl-title">
        <a href="http://www.builive.com" title="文档库地址" target="_blank"><!-- 仅仅为了提供文档的快速入口，项目中请删除链接 -->
          <span class="lp-title-port">青维</span><span class="dl-title-text">后台管理系统</span>
        </a>
      </div>

    <div class="dl-log">欢迎您，<span class="dl-log-user">Dick.Kong</span><a href="#" title="退出系统" class="dl-log-quit">[退出]</a></a>
    </div>
  </div>
   <div class="content">
    <div class="dl-main-nav">
      ...
      <ul id="J_Nav"  class="nav-list ks-clear">
        <li class="nav-item dl-selected"><div class="nav-item-inner nav-home">主页</div></li>
    ...
    BUI.use('common/main',function(){
      var config = [{
          ...
          menu:[{
              text:'公司管理',
              items:[
                {id:'code',text:'用户管理',href:'userList',closeable : false},
                {id:'main-menu',text:'权限管理',href:'main/menu.html'},
